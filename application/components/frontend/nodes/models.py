...
class Node(db.Model):
    ...
    update_date = db.Column('update_date', db.DateTime(timezone=True), nullable=True)
    ...
    def __eq__(self, other):
        ...
        """
        return self.name == other.name if isinstance(other, Node) else NotImplemented
    ...
    def to_dict(self):
        return {
            ...
            'retention': {
                'value': self.rtt_value,
                'column': self.rtt_column
            },
            'active': self.active,
        }
...
class Pipeline(db.Model):
    ...
    id = db.Column('pipeline_id', db.String(64), primary_key=True, nullable=False)
    ...
    def __re_init__(self):
        self.cache_filename = Path(__file__).parent / 'cache' / f'catalog_{self.id}.pickle'
...
class NodeLog(db.Model):
    ...
    name = db.Column('table_name', db.String(64), primary_key=True,  nullable=False)
    ...
    action_type = db.Column('action_type', db.String(64), primary_key=True, nullable=False)
